...
def triangluation(config, cameraNum, output_csv=None, atleast1hit=False):
...
def parse_args() -> Optional[str]:
    ...
    parser.add_argument('--cameraNum', type=int, required=True, help = 'number of camera')
...
def main():
    ...
    args = parse_args()
    print(args)
    triangluation(config=args.config, cameraNum=args.cameraNum, output_csv=args.output_csv, atleast1hit=args.atleast1hit)
