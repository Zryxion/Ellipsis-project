...
def drawCourt():
    ...
    glColor3f(1, 1, 1)
    glBegin(GL_QUADS)
    glVertex3f(-1.14, 2.546, -0.0038)
    glVertex3f(1.14, 2.546, -0.0038)
    glVertex3f(1.14, 2.5308, -0.0038)
    glVertex3f(-1.14, 2.5308, -0.0038)
    glEnd()
    glBegin(GL_QUADS)
    glVertex3f(-1.14, -2.546, -0.0038)
    ...
    glVertex3f(1.14, -2.546, -0.0038)
    glVertex3f(1.14, 2.546, -0.0038)
    glVertex3f(1.1248, 2.546, -0.0038)
    glVertex3f(1.1248, -2.546, -0.0038)
    glEnd()
    glBegin(GL_QUADS)
    glVertex3f(-1.14, -2.546, -0.0038)
    ...
    glColor3f(1, 1, 1)
    glBegin(GL_QUADS)
    glVertex3f(-1.14, (2.546-0.2888), -0.0038)
    glVertex3f(1.14, (2.546-0.2888), -0.0038)
    glVertex3f(1.14, (2.546-0.2888), -0.0038)
    glVertex3f(-1.14, (2.546-0.2888), -0.0038)
    glEnd()
    ...
    glColor3f(1, 1, 1)
    glBegin(GL_QUADS)
    glVertex3f(-1.14, (2.546-1.7784), -0.0038)
    glVertex3f(1.14, (2.546-1.7784), -0.0038)
    glVertex3f(1.14, (2.5308-1.7784), -0.0038)
    glVertex3f(-1.14, (2.5308-1.7784), -0.0038)
    glEnd()
    glBegin(GL_QUADS)
    glVertex3f(-1.14, -(2.546-1.7784), -0.0038)
    ...
    glBegin(GL_QUADS)
    glVertex3f((1.14-0.1748), -2.546, -0.0038)
    glVertex3f((1.14-0.1748), 2.546, -0.0038)
    glVertex3f((1.1248-0.1748), 2.546, -0.0038)
    glVertex3f((1.1248-0.1748), -2.546, -0.0038)
    glEnd()
    glBegin(GL_QUADS)
    glVertex3f(-(1.14-0.1748), -2.546, -0.0038)
    ...
    glBegin(GL_QUADS)
    glVertex3f(-0.0076, 2.546, -0.0038)
    glVertex3f(0.0076, 2.546, -0.0038)
    glVertex3f(0.0076, 0.7524, -0.0038)
    glVertex3f(-0.0076, 0.7524, -0.0038)
    glEnd()
